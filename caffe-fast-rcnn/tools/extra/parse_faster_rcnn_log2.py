...
def parse_log(path_to_log):
    ...
    logfile_year = extract_seconds_frcnn.get_log_created_year(path_to_log)
    with open(path_to_log) as f:
        start_time = extract_seconds_frcnn.get_start_time(f, logfile_year)
        ...
        for line in f:
            ...
            try:
                time = extract_seconds_frcnn.extract_datetime_from_line(line,
                                                                  logfile_year)
            except ValueError:
